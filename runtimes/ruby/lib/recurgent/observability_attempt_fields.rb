    ...
    def _core_attempt_fields(log_context)
      {
        ...
        role_profile_compliance: log_context[:role_profile_compliance],
        role_profile_violation_count: log_context[:role_profile_violation_count],
        role_profile_violation_types: log_context[:role_profile_violation_types],
        role_profile_correction_hint: log_context[:role_profile_correction_hint],
        role_profile_shadow_mode: log_context[:role_profile_shadow_mode],
        role_profile_enforced: log_context[:role_profile_enforced],
