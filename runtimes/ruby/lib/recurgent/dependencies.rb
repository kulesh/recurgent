...
class Agent
  # Agent::Dependencies — manifest resolution, monotonic growth, policy enforcement, env manager.
  # Reads: @role, @runtime_config, @env_manifest, @env_id, @worker_supervisor, @prep_ticket_id
  module Dependencies
    private
