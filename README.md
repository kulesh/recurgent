...
- [`docs/recursim/README.md`](docs/recursim/README.md) - Recursim framework docs (glossary, lane model, shaping mechanisms, calculator evolution tutorial)
...
- **Lua runtime parity is not implemented yet.** Example: runtime-agnostic specs exist, but [`runtimes/lua`](runtimes/lua) is still a placeholder while Ruby carries the active implementation. See [`docs/adrs/0006-monorepo-runtime-boundaries.md`](docs/adrs/0006-monorepo-runtime-boundaries.md), [`docs/roadmap.md`](docs/roadmap.md), and [`runtimes/lua/README.md`](runtimes/lua/README.md).
