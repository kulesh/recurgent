...
- [`live-shadow-simulation-dual-lane-implementation-plan.md`](live-shadow-simulation-dual-lane-implementation-plan.md) - [ADR 0028](../adrs/0028-live-shadow-simulation-and-dual-lane-evidence.md) dual-lane rollout adding run-scoped live-shadow simulation, lane-aware evidence, and advisory promotion criteria
