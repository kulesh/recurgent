...
2. Ensure class-1 simulation readiness gates (`G0`-`G5`) pass in CI for current `main` ([`.github/workflows/simulation-readiness-ci.yml`](../.github/workflows/simulation-readiness-ci.yml)).
